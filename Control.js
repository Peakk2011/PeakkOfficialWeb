...
window.onscroll = function () {
  ...
  if (window.scrollY > 0) {
    document.getElementById('Header').style.height = "35dvh";
    document.getElementById('Header').style.opacity = 0;
    document.querySelector(".headerconn").style.opacity = 0;
    document.querySelector(".headerconn").style.height = "35dvh";
    ...
    document.getElementById('Header').style.background = "rgba(3, 3, 3, 0.750)";
    NavbarContent.style.height = "72px";
    document.querySelector(".headerconn").style.height = "100dvh";
    document.getElementById('Header').style.opacity = 1;
    document.querySelector(".headerconn").style.opacity = 1;
  }
}
